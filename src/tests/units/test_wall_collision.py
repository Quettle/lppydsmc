...
class TestSystem(unittest.TestCase):
    ...
    def test_wall_collision_future(self):
        visual_debug = False
        ...
        pos, radius = Vector(0,0,0), 0.1

        eps = 0.01*radius 
        # simple cases
            # 1
        v = Vector(1,0,0)
        min_time, idx_segment, min_pos_intersect = _collision_with_wall(pos, v, radius, segments)
        self.assertTrue(min_time == 0.9)  # (min_time - 0.9)<eps)
        ...
        new_pos, new_v = _reflect_particle(v, min_time, (segments[idx_segment].get_p2()-segments[idx_segment].get_p1()).normalize(), min_pos_intersect)
        self.assertTrue((new_pos-pos).norm() < eps)
        ...
        v = Vector(-0.5,0,0)
        min_time, idx_segment, min_pos_intersect = _collision_with_wall(pos, v, radius, segments)
        self.assertTrue(min_time == 1.8)
        self.assertTrue(idx_segment == 3)
        self.assertTrue(min_pos_intersect == Vector(-0.9,0,0))
        ...
        v = Vector(0,1,0)
        min_time, idx_segment, min_pos_intersect = _collision_with_wall(pos, v, radius, segments)
        self.assertTrue(min_time == 0.9)
        self.assertTrue(idx_segment == 2)
        self.assertTrue(min_pos_intersect == Vector(0,0.9,0))
        ...
        self.assertTrue(min_pos_intersect == Vector(0.9,0.9))
        ...
        self.assertTrue(min_time == 0.9)
        self.assertTrue(idx_segment == 2)
        self.assertTrue(min_pos_intersect == Vector(0.45,0.9,0))
    ...
    def test_wall_collision_past(self):
        visual_debug = False
